...
public class PlatformMover : RaycastController {
	...
	void CalculatePassengersMovement(Vector3 velocity) {
		...
		// Raised by Vertical Moving Platform
		if (velocity.y != 0) {
		...
		// Pushed by Horizontal Moving Platform
		if (velocity.x != 0) {
		...
		// On top of Downward or Horizontal Moving Platform
